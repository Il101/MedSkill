...
> **Не медицинская консультация и не диагностический инструмент.** Скиллы
> структурируют твои собственные документы и строят гипотезы о возможных
> связях между ними — окончательная интерпретация, диагноз и назначения
> остаются за врачом. Не используй вывод скиллов как основание для лечения
