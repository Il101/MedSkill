...
> Это быстрый старт для оригинальных скиллов (`skills/medical/`). Есть
> доработанный форк — см. `med-plugin/README.md`.

> **Не медицинская консультация.** Скиллы не заменяют врача — интерпретация
> и назначения остаются за специалистом.
